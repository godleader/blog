...
import { navLinks } from "./SideNav"; // Ensure this array has updated nav links
        ...
        <NavbarContent>
          ...
          <NavbarBrand className="basis-0 grow-0">
            <Button
              ...
              variant="solid"
              isIconOnly
              aria-label="Only in Malaysia home page"
              radius="sm"
              className="bg-black/90 text-white"
            >
              OIM {/* Branding for "Only in Malaysia" */}
            </Button>
          </NavbarBrand>
          {/* ---SEARCH BAR--- */}
          <div className="max-md:hidden">
            <SearchInput placeholder="Search Malaysia's hidden gems" />
          </div>
        </NavbarContent>
        {/* ===AUTH USER ACCESS=== */}
        {authStatus ? (
